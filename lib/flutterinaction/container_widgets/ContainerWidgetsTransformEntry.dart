...
class ContainerWidgetsTransformEntry extends BaseEntryPage {
  @override
  Widget createBody() {
    return Column(
      children: <Widget>[
  ...
  @override
  String get routeName => containerWidgetsSub("transform");

  @override
  String get title => "变换Transform";

  @override
  String get url => "https://book.flutterchina.club/chapter5/transform.html";
}
